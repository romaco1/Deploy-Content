...
const BUCKET_ORIGIN = 'goingsolo-production';
const URL_IMAGE_DEPLOY = 'qti-content.adaptemy.com/assets';
...
const COURSES = {
  course1: {
    ...
    publisherID: 1,
    XPUBLISHER: 'MTox',
    authoringApiToken: 'fe7a162f36618476a4432628d63c3254',
    authoringSystemToken: '7213dcfc13ce1993c48bae9f75389b2e'
  },
  course3: {
    courseId: 3,
    publisherID: 3,
    XPUBLISHER: 'Mzoz',
    authoringApiToken: '0c8d53defcf819ab41e1b34306f99739',
    authoringSystemToken: '7213dcfc13ce1993c48bae9f75389b2e'
  },
  course5: {
    courseId: 5,
    publisherID: 3,
    XPUBLISHER: 'Nzoz',
    authoringApiToken: '387d12fcecbae66688411a5eb0996528',
    authoringSystemToken: '7213dcfc13ce1993c48bae9f75389b2e'
  },
  course4: {
    courseId: 4,
    publisherID: 4,
    XPUBLISHER: 'NTo0',
    authoringApiToken: '29d7553e170e2fc739a6b618518b8f33',
    authoringSystemToken: '7213dcfc13ce1993c48bae9f75389b2e'
  }
};
...
function getConceptDocumentPair(conceptId){
  var documentsRes = request("GET", "http://authoringapi-test.adaptemy.com/api/solo/questions?concept_id="+ conceptId +"&course_id=" + course.courseId, {
            headers: {
                ...
                "Authorization": "Bearer " + course.authoringApiToken,
...
function transferDocument(conceptId){
  ...
  if (documentRes.statusCode === 200 ){
    ...
    imagePathsInDocument.forEach(function(imagePath){
      var pattern = new RegExp('"pid:::image:::'+getImageId(imagePath)+'"','g');
      doc = doc.replace(pattern, '"'+ 'https://'+ URL_IMAGE_DEPLOY + '/' + imagePath +'"');
    });
...
function getImagePaths(){
  ...
  var options = {
    ...
    prefix: course.publisherID + '/'+ course.courseId + '/assets/image/'
  };
...
function copyObjectS3(file){
    console.log('Params copyObjectS3: '); 
    console.log('Bucket: ',BUCKET_DEPLOY);
    console.log('CopySource: ',BUCKET_ORIGIN + '/' + file);
    var urlFileImage =  'assets/'+file;
    console.log('Key file',urlFileImage);
...
function getAuthoringVariabilizationDocument(documentId){
  var variabilizationResponse = request('GET', 'http://authoring-system.adaptemy.com/document/variablization?documentId='+ documentId +'&course_id='+ course.courseId + '&context%5BeditSessionToken%5D='+ course.authoringSystemToken, {
    headers: {
        "Content-Type": "application/json"
    }
  });
